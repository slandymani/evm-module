...
import (
	...
	"github.com/slandymani/evm-module/x/evm/keeper"
...
func (suite *EvmTestSuite) DoSetupTest(t require.TestingT) {
	...
	suite.app = app.EthSetup(checkTx, func(app *app.EvmM, genesis evmmoduletypes.GenesisState) evmmoduletypes.GenesisState {
