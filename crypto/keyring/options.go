...
import (
	...
	"github.com/slandymani/evm-module/ledger"
)

// AppName defines the Ledger app used for signing. Evmm Network uses the Ethereum app
const AppName = "Ethereum"

var (
	// SupportedAlgorithms defines the list of signing algorithms used on Evmm Network:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Evmm Network for the Ledger device:
	...
	// LedgerDerivation defines the Evmm Network Ledger Go derivation (Ethereum app with EIP-712 signing)
