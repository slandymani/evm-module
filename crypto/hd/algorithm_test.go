...
import (
	...
	cryptocodec "github.com/slandymani/evm-module/crypto/codec"
	enccodec "github.com/slandymani/evm-module/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("evmm", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, evmmoduletypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
	...
	hdPath := evmmoduletypes.BIP44HDPath
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, evmmoduletypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(evmmoduletypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Evmm implementation
	...
	// Equality of Eth and Evmm implementation
	...
	// Inequality of wrong derivation path of Eth and Evmm implementation
