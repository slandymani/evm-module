...
import (
	...
	clientkeys "github.com/slandymani/evm-module/client/keys"
	"github.com/slandymani/evm-module/crypto/hd"
	evmmkr "github.com/slandymani/evm-module/crypto/keyring"
	"github.com/slandymani/evm-module/tests/integration/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupEvmmApp() {
...
func (suite *LedgerTestSuite) evmmAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = evmmkr.SupportedAlgorithms
		options.SupportedAlgosLedger = evmmkr.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = evmmkr.CreatePubkey
		options.LedgerAppName = evmmkr.AppName
		options.LedgerSigSkipDERConv = evmmkr.SkipDERConversion
	}
}
