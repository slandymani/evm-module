...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*evmmoduletypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*evmmoduletypes.TxResult, error)
...
type Backend struct {
	...
	indexer             evmmoduletypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := evmmoduletypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
