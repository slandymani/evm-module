...
import (
	...
	rpctypes "github.com/slandymani/evm-module/rpc/types"
...
var _ evmmoduletypes.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) IndexBlock(block *tmtypes.Block, txResults []*abci.ResponseDeliverTx) error {
	...
	for txIndex, tx := range block.Txs {
		...
		for msgIndex, msg := range tx.GetMsgs() {
			...
			txResult := evmmoduletypes.TxResult{
				Height:     height,
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*evmmoduletypes.TxResult, error) {
	...
	var txKey evmmoduletypes.TxResult
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*evmmoduletypes.TxResult, error) {
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *evmmoduletypes.TxResult) error {
